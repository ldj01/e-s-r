...
bool cloud_detection_pass1(Lut_t *lut, int nsamp, int il, int16 **line_in,
                           uint8 *qa_line, int16 *b6_line,float *atemp_line,
                           atmos_t *atmos_coef, atmos_t *interpol_atmos_coef,
                           cld_diags_t *cld_diags);
bool cloud_detection_pass2(Lut_t *lut, int nsamp, int il, int16 **line_in,
                           uint8 *qa_line, int16 *b6_line,
                           atmos_t *atmos_coef, atmos_t *interpol_atmos_coef,
